    ...
    <>
      ...
      <aside className={`sidebar ${sidebarOpen ? 'sidebar-visible' : ''}`}>
        ...
        <div className="sidebar-brand">
          ...
          <div>
            <div className="brand-name">QR Studio</div>
            <div className="brand-tagline">QR Creation Platform</div>
          </div>
        </div>
        ...
        <nav className="sidebar-nav">
          ...
          {NAV_ITEMS.map(item => (
            <NavLink
              ...
              onClick={() => onToggleSidebar && sidebarOpen && onToggleSidebar()}
            >
        ...
        <div className="sidebar-footer">
          <div className="sidebar-user">
            ...
            <div className="sidebar-user-info">
              ...
              <div className="sidebar-user-role">QR Studio</div>
            </div>
          </div>
